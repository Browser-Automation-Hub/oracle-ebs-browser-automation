/**
 * auth.js — Authentication handler for Oracle E-Business Suite
 * Supports: SSO (Oracle SSO / LDAP / OAM), MFA (Oracle MFA / RSA)
 *
...
const BASE_URL = process.env.ORACLE_EBS_URL || 'https://your-ebs.example.com/OA_HTML/AppsLogin';
...
async function performLogin(page) {
  if (!USERNAME || !PASSWORD) {
    throw new Error(`Set ORACLE_EBS_USERNAME and ORACLE_EBS_PASSWORD in .env`);
  }

  console.log('Logging in to Oracle E-Business Suite...');
  await page.goto(BASE_URL, { waitUntil: 'networkidle2' });
