/**
 * basic-login.js — Basic login example for Oracle E-Business Suite
...
async function main() {
  ...
  try {
    log('Starting Oracle E-Business Suite automation (Open Source mode)');
    ...
    const result = await login_ebs(page, {
    ...
    // const data = await navigate_responsibility(page, {});
    // log('Data:', data);
